...
knitr::opts_chunk$set(echo = TRUE, fig.path='{{ site.url }}/images/raster-footprints',fig.align='center',results='hold',warning=FALSE,prompt=FALSE,out.width='80%',fig.height=4)
```
...
```{r libs, message=FALSE, collapse=TRUE}
library(sp)
library(raster)
library(rgdal)
library(rasterVis)
...
End result:
```{r output, echo=FALSE, results='hide', message=FALSE}
